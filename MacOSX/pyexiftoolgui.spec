# -*- mode: python -*-
a = Analysis(['/Users/Shared/development/python_related/pyside/pyExifToolGUI-0.5/scripts/pyexiftoolgui.py'],
             pathex=['/Users/Shared/development/python_related/pyinstaller-2.0', '/Users/Shared/development/python_related/pyside/pyExifToolGUI-0.5/scripts/', '/Users/Shared/development/python_related/pyside/pyExifToolGUI-0.5/scripts/ui/'],
             hiddenimports=[],
             hookspath=None)
pyz = PYZ(a.pure)
exe = EXE(pyz,
          ...
          strip=None,
          upx=True,
          console=False , icon='/Users/Shared/development/python_related/pyside/pyExifToolGUI-0.5/MacOSX/pyExifToolGUI.app/Contents/Resources/appIcon.icns' )
coll = COLLECT(exe,
               a.binaries +
               ...
               [('../Resources/qt.conf', '/Users/Shared/development/python_related/pyside/pyExifToolGUI-0.5/MacOSX/qt.conf', 'DATA')] +
               [('COPYING', '/Users/Shared/development/python_related/pyside/pyExifToolGUI-0.5/COPYING', 'DATA')] +
               [('../Resources/appIcon.icns', '/Users/Shared/development/python_related/pyside/pyExifToolGUI-0.5/MacOSX/appIcon.icns', 'DATA')] +
               [('../Info.plist', '/Users/Shared/development/python_related/pyside/pyExifToolGUI-0.5/MacOSX/Info.plist', 'DATA')] +
               [('../PkgInfo', '/Users/Shared/development/python_related/pyside/pyExifToolGUI-0.5/MacOSX/PkgInfo', 'DATA')] +
