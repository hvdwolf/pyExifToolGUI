# -*- mode: python -*-
a = Analysis(['..\\pyside\\pyexiftoolgui-0.5.1\\scripts\\pyexiftoolgui.py'],
             pathex=['D:\\LocalData_387640\\Datadir\\python\\pyinstaller-2.0', '..\\pyside\\pyexiftoolgui-0.5.1\\scripts\\', '..\\pyside\\pyexiftoolgui-0.5.1\\scripts\\ui'],
             hiddenimports=[],
             hookspath=None)
pyz = PYZ(a.pure )
exe = EXE(pyz,
